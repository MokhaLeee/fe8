...
struct ProcScr CONST_DATA ProcScr_CpDecide[] =
{
...
next_unit:
    ...
    if (*gAiSt.unitIt)
    {
        ...
        {
            gAiSt.unitIt++;
            SpawnProcLocking(ProcScr_CpPerform, proc);
        }
    }
    else
    {
...
void CpDecide_Main(ProcPtr proc)
{
    ...
    .L08039B04:\n\
        ...
        adds r0, #0x7c\n\
        strb r1, [r0]\n\
        ldr r1, .L08039B4C  @ gActiveUnitId\n\
        ldrb r0, [r2]\n\
        strb r0, [r1]\n\
        ldrb r0, [r1]\n\
        bl GetUnit\n\
        adds r1, r0, #0\n\
        ldr r6, .L08039B50  @ gActiveUnit\n\
        str r1, [r6]\n\
        ldr r5, [r1, #0xc]\n\
        movs r0, #6\n\
        ands r5, r0\n\
    ...
    .L08039B3E:\n\
        ...
        b .L08039B04\n\
        .align 2, 0\n\
    .L08039B48: .4byte gAiSt\n\
    .L08039B4C: .4byte gActiveUnitId\n\
    .L08039B50: .4byte gActiveUnit\n\
    .L08039B54:\n\
        ...
        bl SetupAiDangerMap\n\
        bl ClearAiDecision\n\
        ldr r0, .L08039BD0  @ AiDecideMainFunc\n\
        ldr r0, [r0]\n\
        bl _call_via_r0\n\
        ldr r2, [r6]\n\
        ldr r0, [r2, #0xc]\n\
    ...
    .L08039BBE:\n\
        ...
        b .L08039BFA\n\
        .align 2, 0\n\
    .L08039BD0: .4byte AiDecideMainFunc\n\
    .L08039BD4: .4byte gAiDecision\n\
    .L08039BD8:\n\
        ldr r0, .L08039BEC  @ gAiSt\n\
        ldr r1, [r0, #0x74]\n\
        adds r1, #1\n\
        str r1, [r0, #0x74]\n\
        ldr r0, .L08039BF0  @ ProcScr_CpPerform\n\
        adds r1, r7, #0\n\
        bl SpawnProcLocking\n\
        b .L08039BFA\n\
        .align 2, 0\n\
    .L08039BEC: .4byte gAiSt\n\
    .L08039BF0: .4byte ProcScr_CpPerform\n\
    .L08039BF4:\n\
        adds r0, r7, #0\n\
        bl Proc_End\n\
    .L08039BFA:\n\
