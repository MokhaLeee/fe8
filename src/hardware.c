...
i8 EWRAM_DATA gUnknown_02022288[0x20] = {};
i8 EWRAM_DATA gUnknown_020222A8[0x600] = {};
...
void func_08000E14(void const* data, int offset, int length, int q6_brightness)
{
    #define R_MASK (0x1F)
...
void func_0800151C(u8 a, u8 b)
{
    sUnknown_03000018 = a;
    sUnknown_03000019 = b;
}

void func_08001530(u16* a, u16 const* b)
{
    int i;
...
void func_0800154C(void* outTm, void const* inData, u8 base, u8 linebits)
{
...
#if NONMATCHING
void func_0800159C(u16 *a, u8 *b, i16 c, i16 d, u16 e)
{
    i16 sb = c;  // i16?
    i16 r3 = d;  // i16?
    i16 ip  = b[0] + 1;
    ...
    i16 spC = 0;
    i16 sp8 = 0;  // sp8 = spC = 0
    i16 r8;  // r4 in the beginning
    i16 r4;  // r5 in the beginning
...
#else
__attribute__((naked))
void func_0800159C(u16 *a, u16 *b, i16 c, i16 d, u16 e)
{
    asm(".syntax unified\n\
    push {r4, r5, r6, r7, lr}\n\
    mov r7, sl\n\
...
void func_080016C4(u16* outTm, short const* inData, int unused)
{
...
void func_0800172C(u16 const* inPal, int bank, int count, int unk)
{
    int iBank, iColor;
...
void func_080017B4(int a, int b, int c, int d)
{
    int iBank;
    int iColor;
    int destOffset = a * 16;
...
void func_0800183C(int a, int b, int c)
{
    int i;
