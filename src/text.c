...
.L080041A8:\n\
	...
	lsls r0, r2, #2\n\
	adds r0, r0, r1\n\
	ldr r1, .L080041B8  @ 0xFFFFFF00\n\
	adds r0, r0, r1\n\
	ldr r1, [r0]\n\
	b .L080041BE\n\
	.align 2, 0\n\
.L080041B8: .4byte 0xFFFFFF00\n\
.L080041BC:\n\
	ldr r1, [r1]\n\
.L080041BE:\n\
	cmp r1, #0\n\
	...
	movs r3, #0x81\n\
	movs r2, #0xa7\n\
	ldr r6, .L080041CC  @ gActiveFont\n\
	b .L080041A8\n\
	.align 2, 0\n\
.L080041CC: .4byte gActiveFont\n\
.L080041D0:\n\
	ldrb r0, [r1, #4]\n\
	cmp r0, r3\n\
	bne .L080041BC\n\
