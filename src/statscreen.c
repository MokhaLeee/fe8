...
static Unit_t* FindNextUnit(Unit_t* u, int direction);
...
static void StartPageSlide(u16 config, int newPage, Proc_t* parent);
...
static void ClearSlide(Proc_t* proc);
static void StartUnitSlide(Unit_t* unit, int direction, Proc_t* parent);
...
static void StatScreen_InitDisplay(Proc_t* proc);
static void StatScreen_Display(Proc_t* proc);
static void StatScreen_OnIdle(Proc_t* proc);
static void StatScreen_OnClose(void);
static void StatScreen_ResumeFromHelp(void);
static void BgOffCtrl_OnLoop(void);
static void StartStatScreenHelp(int pageid, Proc_t* proc);
...
static void HbLock_OnIdle(Proc_t* proc);
...
{
    { gStatScreen.text + STATSCREEN_TEXT_SKLLABEL,   gBmFrameTmap0 + TM_OFFSET(1, 3),  TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Skl },
    { gStatScreen.text + STATSCREEN_TEXT_SPDLABEL,   gBmFrameTmap0 + TM_OFFSET(1, 5),  TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Spd },
    { gStatScreen.text + STATSCREEN_TEXT_LCKLABEL,   gBmFrameTmap0 + TM_OFFSET(1, 7),  TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Lck },
    { gStatScreen.text + STATSCREEN_TEXT_DEFLABEL,   gBmFrameTmap0 + TM_OFFSET(1, 9),  TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Def },
    { gStatScreen.text + STATSCREEN_TEXT_RESLABEL,   gBmFrameTmap0 + TM_OFFSET(1, 11), TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Res },
    { gStatScreen.text + STATSCREEN_TEXT_MOVLABEL,   gBmFrameTmap0 + TM_OFFSET(9, 1),  TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Mov },
    { gStatScreen.text + STATSCREEN_TEXT_CONLABEL,   gBmFrameTmap0 + TM_OFFSET(9, 3),  TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Con },
    { gStatScreen.text + STATSCREEN_TEXT_AIDLABEL,   gBmFrameTmap0 + TM_OFFSET(9, 5),  TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Aid },
    { gStatScreen.text + STATSCREEN_TEXT_RESCUENAME, gBmFrameTmap0 + TM_OFFSET(9, 7),  TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Trv },
    { gStatScreen.text + STATSCREEN_TEXT_AFFINLABEL, gBmFrameTmap0 + TM_OFFSET(9, 9),  TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Affin },
    { gStatScreen.text + STATSCREEN_TEXT_STATUS,     gBmFrameTmap0 + TM_OFFSET(9, 11), TEXT_COLOR_SYSTEM_GOLD, 0, &gMid_Cnd },
...
{
    { gStatScreen.text + STATSCREEN_TEXT_BSATKLABEL, gBmFrameTmap0 + TM_OFFSET(2, 13), TEXT_COLOR_SYSTEM_GOLD, 6, &gMid_Atk },
    { gStatScreen.text + STATSCREEN_TEXT_BSHITLABEL, gBmFrameTmap0 + TM_OFFSET(2, 15), TEXT_COLOR_SYSTEM_GOLD, 6, &gMid_Hit },
    { gStatScreen.text + STATSCREEN_TEXT_BSRANGE,    gBmFrameTmap0 + TM_OFFSET(9, 11), TEXT_COLOR_SYSTEM_GOLD, 6, &gMid_Rng },
    { gStatScreen.text + STATSCREEN_TEXT_BSCRTLABEL, gBmFrameTmap0 + TM_OFFSET(9, 13), TEXT_COLOR_SYSTEM_GOLD, 6, &gMid_Crt },
    { gStatScreen.text + STATSCREEN_TEXT_BSAVOLABEL, gBmFrameTmap0 + TM_OFFSET(9, 15), TEXT_COLOR_SYSTEM_GOLD, 6, &gMid_Avo },
...
{
    { gStatScreen.text + STATSCREEN_TEXT_WEXP0, gBmFrameTmap0 + TM_OFFSET(3,  1), TEXT_COLOR_SYSTEM_WHITE, 0, &gMid_Sword },
    { gStatScreen.text + STATSCREEN_TEXT_WEXP1, gBmFrameTmap0 + TM_OFFSET(3,  3), TEXT_COLOR_SYSTEM_WHITE, 0, &gMid_Lance },
    { gStatScreen.text + STATSCREEN_TEXT_WEXP2, gBmFrameTmap0 + TM_OFFSET(11, 1), TEXT_COLOR_SYSTEM_WHITE, 0, &gMid_Axe },
    { gStatScreen.text + STATSCREEN_TEXT_WEXP3, gBmFrameTmap0 + TM_OFFSET(11, 3), TEXT_COLOR_SYSTEM_WHITE, 0, &gMid_Bow },
...
{
    { gStatScreen.text + STATSCREEN_TEXT_WEXP0, gBmFrameTmap0 + TM_OFFSET(3,  1), TEXT_COLOR_SYSTEM_WHITE, 0, &gMid_Anima },
    { gStatScreen.text + STATSCREEN_TEXT_WEXP1, gBmFrameTmap0 + TM_OFFSET(3,  3), TEXT_COLOR_SYSTEM_WHITE, 0, &gMid_Light },
    { gStatScreen.text + STATSCREEN_TEXT_WEXP2, gBmFrameTmap0 + TM_OFFSET(11, 1), TEXT_COLOR_SYSTEM_WHITE, 0, &gMid_Dark },
    { gStatScreen.text + STATSCREEN_TEXT_WEXP3, gBmFrameTmap0 + TM_OFFSET(11, 3), TEXT_COLOR_SYSTEM_WHITE, 0, &gMid_Staff },

    { }, // end
};

static
struct TextInitInfo CONST_DATA sSSMasterTextBatch[] =
{
...
static
i8 CONST_DATA sPageSlideOffsetLut[] = // stat screen page transition draw offset lut
{
    // transition page out
    -4, -7, -10, -12, -14,
...
struct ProcScr CONST_DATA ProcScr_SSPageSlide[] =
{
...
struct ProcScr CONST_DATA ProcScr_SSGlowyBlendCtrl[] =
{
    PROC_SLEEP(0),
...
struct ProcScr CONST_DATA ProcScr_SSUnitSlide[] =
{
    PROC_SLEEP(0),
...
struct ProcScr CONST_DATA ProcScr_SSPageNameCtrl[] =
{
...
struct ProcScr CONST_DATA ProcScr_SSPageNumCtrl[] =
{
...
struct ProcScr CONST_DATA ProcScr_SSBgOffsetCtrl[] =
{
...
struct ProcScr CONST_DATA ProcScr_StatScreen[] =
{
    ...
    PROC_START_CHILD(ProcScr_SSGlowyBlendCtrl),
    PROC_START_CHILD(ProcScr_SSPageNameCtrl),
    PROC_START_CHILD(ProcScr_SSPageNumCtrl),
    PROC_START_CHILD(ProcScr_SSBgOffsetCtrl),
...
PROC_LABEL(10),
    ...
    PROC_END_EACH(ProcScr_SSGlowyBlendCtrl),
...
struct ProcScr CONST_DATA ProcScr_HelpBoxMoveCtrl[] =
{
    PROC_SLEEP(1),
...
struct ProcScr CONST_DATA ProcScr_HelpBoxLock[] =
{
...
struct ProcScr CONST_DATA ProcScr_HelpPromptSpr[] = // proc displaying 'R is Info'
{
    PROC_SLEEP(0),
...
{
    return sStatScreenInfo.unit_id;
}

void SetLastStatScreenUid(int uid)
{
    sStatScreenInfo.unit_id = uid;
}
...
void InitTexts(void)
{
    InitTextList(sSSMasterTextBatch);
}
...
void DisplayLeftPanel(void)
{
    ...
    PutDrawText(
        ...
        GetMsg(gStatScreen.unit->jinfo->name_msg));

    // Display Lv/E labels
    PutTwoSpecialChar(gBg0Tm + TM_OFFSET(1, 15), TEXT_COLOR_SYSTEM_GOLD, 0x24, 0x25);
    PutSpecialChar(gBg0Tm + TM_OFFSET(5, 15), TEXT_COLOR_SYSTEM_GOLD, 0x1D);

    // Display Hp/'/' labels
    PutTwoSpecialChar(gBg0Tm + TM_OFFSET(1, 17), TEXT_COLOR_SYSTEM_GOLD, 0x22, 0x23);
    PutSpecialChar(gBg0Tm + TM_OFFSET(5, 17), TEXT_COLOR_SYSTEM_GOLD, 0x16);

    // Display level
    PutNumberOrBlank(gBg0Tm + TM_OFFSET(4, 15), TEXT_COLOR_SYSTEM_BLUE,
        gStatScreen.unit->level);

    // Display exp
    PutNumberOrBlank(gBg0Tm + TM_OFFSET(7, 15), TEXT_COLOR_SYSTEM_BLUE,
...
void DisplayBwl(void)
{
    ...
    // Display Battle Amt
    PutNumber(gBmFrameTmap0 + TM_OFFSET(3 + func_080AEBEC(stats->battleAmt), 14),
        TEXT_COLOR_SYSTEM_BLUE, stats->battleAmt);

    // Display Win Amt
    PutNumber(gBmFrameTmap0 + TM_OFFSET(7 + func_080AEBEC(stats->winAmt), 14),
        TEXT_COLOR_SYSTEM_BLUE, stats->winAmt);

    // Display Loss Amt
    PutNumber(gBmFrameTmap0 + TM_OFFSET(11 + func_080AEBEC(stats->lossAmt), 14),
...
void DrawStatWithBar(int num, int x, int y, int base, int total, int max)
{
    ...
    PutNumberOrBlank(gBmFrameTmap0 + TM_OFFSET(x, y),
        (base == max) ? TEXT_COLOR_SYSTEM_GREEN : TEXT_COLOR_SYSTEM_BLUE, base);

    PutNumberBonus(diff, gBmFrameTmap0 + TM_OFFSET(x + 1, y));
...
void DisplayPage0(void)
{
    ...
    // displaying unit aid
    PutNumberOrBlank(gBmFrameTmap0 + TM_OFFSET(13, 5), TEXT_COLOR_SYSTEM_BLUE,
...
void DisplayPage1(void)
{
    ...
    if (!UNIT_IS_GORGON_EGG(gStatScreen.unit))
    {
        PutNumberOrBlank(
            ...
            TEXT_COLOR_SYSTEM_BLUE, gBattleUnitA.attack);

        PutNumberOrBlank(
            gBmFrameTmap0 + TM_OFFSET(8,  15),
            TEXT_COLOR_SYSTEM_BLUE, gBattleUnitA.hit_raw);

        PutNumberOrBlank(
            gBmFrameTmap0 + TM_OFFSET(15, 13),
            TEXT_COLOR_SYSTEM_BLUE, gBattleUnitA.crit_raw);

        PutNumberOrBlank(
            gBmFrameTmap0 + TM_OFFSET(15, 15),
            TEXT_COLOR_SYSTEM_BLUE, gBattleUnitA.avoid);
    }
    else
    {
        PutNumberOrBlank(
...
void DisplaySupportList(void)
{
    ...
    int supportAmt = GetUnitSupportCount(gStatScreen.unit);
    int supportId  = 0;
    ...
    while (supportId < supportAmt)
    {
        ...
        if (level != 0)
        {
            ...
            u8 pid = GetUnitSupportPid(gStatScreen.unit, supportId);
            ...
            PutSpecialChar(gBmFrameTmap0 + TM_OFFSET(13, yTile),
                rankColor, GetSupportLevelSpecialChar(level));
...
void DisplayWeaponExp(int num, int x, int y, int wtype)
{
    ...
    GetWeaponExpProgression(wexp, &progress, &progressMax);

    func_08086B2C(0x401 + num*6, 5,
...
void DisplayPage2(void)
{
    if (UnitKnowsMagic(gStatScreen.unit))
    {
        ...
        DisplayWeaponExp(0, 1, 1, ITEM_KIND_ANIMA);
        DisplayWeaponExp(1, 1, 3, ITEM_KIND_LIGHT);
        DisplayWeaponExp(2, 9, 1, ITEM_KIND_DARK);
        DisplayWeaponExp(3, 9, 3, ITEM_KIND_STAFF);
    }
    else
    {
        // NOTE: this was likely present in the J version
        ...
        DisplayWeaponExp(0, 1, 1, ITEM_KIND_SWORD);
        DisplayWeaponExp(1, 1, 3, ITEM_KIND_LANCE);
        DisplayWeaponExp(2, 9, 1, ITEM_KIND_AXE);
        DisplayWeaponExp(3, 9, 3, ITEM_KIND_BOW);
    }
...
static
Unit_t* FindNextUnit(Unit_t* u, int direction)
{
...
static
void StartPageSlide(u16 key, int newPage, Proc_t* parent)
{
    struct StatScreenEffectProc* proc;

    if (FindProc(ProcScr_SSPageSlide))
        return;

    PlaySe(0x6F); // TODO: song ids

    proc = (void*) SpawnProcLocking(ProcScr_SSPageSlide, parent);
...
{
    SpawnProc(ProcScr_SSGlowyBlendCtrl, PROC_TREE_3);
}

static
void EndGlowBlendCtrl(struct StatScreenEffectProc* proc)
{
    EndEachProc(ProcScr_SSGlowyBlendCtrl);
...
void UnitSlide_SetNewUnit(struct StatScreenEffectProc* proc)
{
    ...
    StatScreen_Display(FindProc(ProcScr_StatScreen));
    Proc_Break(proc);
}

static
void ClearSlide(Proc_t* proc)
{
    if (gStatScreen.mu)
        MU_SetDisplayPosition(gStatScreen.mu,
            80, 138);
...
static
void StartUnitSlide(Unit_t* unit, int direction, Proc_t* parent)
{
    struct StatScreenEffectProc* proc = (void*) SpawnProcLocking(ProcScr_SSUnitSlide, parent);
...
{
    i8 displayIcon = (GetGameTime() % 32) < 20;
    ...
    if (!gStatScreen.inTransition)
    {
        ...
        {
            func_08015BD4(120, 40, 1);
            func_08015BD4(120, 56, 1);
...
static
void StatScreen_InitDisplay(Proc_t* proc)
{
    u16 bgConfig[12] =
    {
        0x0000, 0x6000, 0,
...
static
void StatScreen_Display(Proc_t* proc)
{
    // Get portrait id
...
static
void StatScreen_OnIdle(Proc_t* proc)
{
    Unit_t* unit;
...
void StatScreen_OnClose(void)
{
    ...
    sStatScreenInfo.unit_id = gStatScreen.unit->id;
...
void StartStatScreenHelp(int pageid, Proc_t* proc)
{
...
{
    int midDesc = gStatScreen.unit->pinfo->desc_msg;
...
{
    proc->mid = gStatScreen.unit->jinfo->desc_msg;
}
...
{
    Proc_t* found = FindProc(ProcScr_HelpPromptSpr);
...
void StartHelpBoxFromInfo(const struct HelpBoxInfo* info, int unk)
{
    ...
    proc = (void*) FindProc(ProcScr_HelpBox);

    if (!proc)
    {
        proc = (void*) SpawnProc(ProcScr_HelpBox, PROC_TREE_3);
...
{
    struct HelpBoxProc* proc = (void*) FindProc(ProcScr_HelpBox);
...
{
    struct HelpBoxProc* proc = (void*) SpawnProcLocking(ProcScr_HelpBoxMoveCtrl, parent);
...
static
void HbLock_OnIdle(Proc_t* proc)
{
    if (gKeySt->pressed & (B_BUTTON | R_BUTTON))
        Proc_Break(proc);
}
...
int StartLockingHelpBox_Unused(int mid, Proc_t* parent)
{
    ...
    SpawnProcLocking(ProcScr_HelpBoxLock, parent);
...
{
    struct HelpPromptSprProc* proc = (void*) FindProc(ProcScr_HelpPromptSpr);

    if (!proc)
        proc = (void*) SpawnProc(ProcScr_HelpPromptSpr, parent);
...
Proc_t* StartHelpPromptSprite_Unused2(int x, int y, Proc_t* parent)
{
    ...
    if (!proc)
        proc = (void*) SpawnProcLocking(ProcScr_HelpPromptSpr, parent);
...
{
    Proc_t* proc = FindProc(ProcScr_HelpPromptSpr);
...
void func_08037494(struct HelpBoxProc* proc);
void func_080374C4(struct HelpBoxProc* proc);
