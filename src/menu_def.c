...
const struct MenuInfo MenuInfo_DebugClear = {
    {1, 6, 0xd, 0},
    0,
...
const struct MenuInfo MenuInfo_DebugCharge = {
    {1, 1, 0xa, 0},
    0,
...
const struct MenuInfo MenuInfo_DebugContinue = {
    {9, 4, 0xc, 0},
    0,
...
const struct MenuInfo MenuInfo_DebugChuudan = {
    {1, 1, 0xa, 0},
    0,
...
const struct MenuInfo MenuInfo_Debug = {
    {1, 1, 15, 0},
    0,
    gDebugMenuItems,
    DebugMenuInit,
...
const struct MenuInfo MenuInfo_RepairItems = {
    {0, 1, 0x10, 0},
    0,
    gItemUseMenuItems,
    0, 0, 0,
...
const struct MenuInfo MenuInfo_StealItem = {
    {0xe, 4, 0xe, 0},
    0,
    gStealItemMenuItems,
    0, 0, 0,
...
const struct MenuInfo MenuInfo_Convoy = {
    {1, 1, 0xe, 0},
    0,
    gConvoyMenuItems,
    0, 0, 0, 0,
...
const struct MenuInfo MenuInfo_SendToConvoy = {
    {1, 1, 0xe, 0},
    0,
...
const struct MenuInfo MenuInfo_YesNoSelection = {
    {0, 0, 5, 0},
    1,
...
const struct MenuInfo MenuInfo_ItemSub = {
    {0, 0, 7, 0},
    1,
    gItemSubMenuItems,
    0,
...
const struct MenuInfo MenuInfo_Item = {
    {1, 1, 0xe, 0},
    0,
    gItemMenuItems,
    0, 0, 0,
...
const struct MenuInfo MenuInfo_StaffItemSelect = {
    {1, 1, 0xe, 0},
    0,
...
const struct MenuInfo MenuInfo_ItemSelect = {
    {1, 1, 0xe, 0},
    0,
...
const struct MenuInfo MenuInfo_BallistaRange = {
    {1, 1, 0xe, 0},
    0,
...
const struct MenuInfo MenuInfo_Unknown = {
    {1, 1, 0xe, 0},
    0,
    gUnknownMenuItems,
    0, 0, 0,
...
const struct MenuInfo MenuInfo_UnitAction = {
    {1, 3, 7, 0},
    0,
...
const struct MenuInfo MenuInfo_Map = {
    {1, 2, 7, 0},
    0,
    gMapMenuItems,
    0, 0, 0,
