...
void func_08005D64(ProcPtr);
void func_08005D70(ProcPtr);
void func_08005D98(ProcPtr);
void EndFacePtr(ProcPtr);
void func_08005FD4(ProcPtr);
void func_08005FE0(ProcPtr);
void func_0800623C(ProcPtr);
void func_08006280(ProcPtr);
void func_080062B8(ProcPtr);
void func_08006324(ProcPtr);
void func_0800632C(ProcPtr);
void func_08006370(ProcPtr);
void func_08006378(ProcPtr);
void func_080063BC(ProcPtr);
void func_080063C4(ProcPtr);
...
{
    PROC_CALL(func_08005D64),

PROC_LABEL(0),
    PROC_REPEAT(func_08005D70),
    PROC_REPEAT(func_08005D98),
...
{
    PROC_CALL(func_08005FD4),
    PROC_REPEAT(func_08005FE0),
...
{
PROC_LABEL(0),
    PROC_CALL(func_0800623C),

PROC_LABEL(0),
    PROC_REPEAT(func_08006280),

PROC_LABEL(1),
    PROC_REPEAT(func_080062B8),

PROC_LABEL(2),
    PROC_CALL(func_08006324),
    PROC_REPEAT(func_0800632C),
    PROC_REPEAT(func_08006280),

PROC_LABEL(3),
    PROC_CALL(func_08006370),
    PROC_REPEAT(func_08006378),
    PROC_REPEAT(func_08006280),

PROC_LABEL(4),
    PROC_CALL(func_080063BC),
    PROC_REPEAT(func_080063C4),
