...
const char *StrGetGenericArticle(i8 *a, i8 b)
{
    switch (a[0])
    {
    case 'A':
...
void StrStripSomeEndCharacters(i8 *a)
{
    i16 r3 = 0;
    u8 r1;
    ...
    while (*r5 != 0)
    {
        ...
        else
        {
            ...
            case 0x15:
                ...
                break;
            case 0x20:
                StringCopy(r4, GetTacticianName());
                goto label;
            case 0x22:
            ...
            StringCopy(r4, GetMsg(GetPInfo(gPlaySt.item_kind_seals[r1])->name_msg));
        label:
            while (*r4 != 0)
                r4++;
            r5++;
...
char *StrExpandTact(void)
{
    asm(".syntax unified\n\
    push {r4, r5, lr}\n\
    ldr r5, .L0800A3D0  @ gUnknown_0202B4AC\n\
    movs r0, #0x80\n\
    lsls r0, r0, #1\n\
    adds r4, r5, r0\n\
    ldr r0, .L0800A3D4  @ 0xFFFFF200\n\
    adds r1, r5, r0\n\
    adds r0, r5, #0\n\
    bl StringCopy\n\
    b .L0800A416\n\
    .align 2, 0\n\
.L0800A3D0: .4byte gUnknown_0202B4AC\n\
.L0800A3D4: .4byte 0xFFFFF200\n\
.L0800A3D8:\n\
    adds r1, r0, #0\n\
    cmp r1, #0x1f\n\
    bls .L0800A3F0\n\
...
.L0800A416:\n\
    ...
    movs r0, #0\n\
    strb r0, [r4]\n\
    ldr r0, .L0800A428  @ gUnknown_0202B5AC\n\
    pop {r4, r5}\n\
    pop {r1}\n\
    bx r1\n\
    .align 2, 0\n\
.L0800A428: .4byte gUnknown_0202B5AC\n\
    .syntax divided");
}
#endif
