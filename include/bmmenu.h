// TODO [2021-10-09]: clean up and update to stan standards
...
int nullsub_25(struct MenuProc*, struct MenuItemProc*);
...
int nullsub_26(struct MenuProc*, struct MenuItemProc*);
...
int AttackWeaponSelect_ItemOnSwitchOut(struct MenuProc*, struct MenuItemProc*);
...
int AttackWeaponSelect_ItemOnSwitchIn(struct MenuProc*, struct MenuItemProc*);
...
u8 AttackCommandEffect(struct MenuProc*, struct MenuItemProc*);
...
u8 MapMenuCommand_UnitEffect(struct MenuProc*, struct MenuItemProc*);
u8 MapMenuCommnd_StatusEffect(struct MenuProc*, struct MenuItemProc*);
...
u8 MapMenuCommnd_GuideEffect(struct MenuProc*, struct MenuItemProc*);
...
u8 MapMenuCommnd_EndEffect(struct MenuProc*, struct MenuItemProc*);
